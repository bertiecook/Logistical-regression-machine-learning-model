...
## Project overview
My goal here was to construct a logistical regression model from the ground up that could classify breast cancer cells to a high degree of accuracy.
...
s
When applied to real-world cancer dataset with added b variable I achieved 91.6% accuracy on the training-set.
